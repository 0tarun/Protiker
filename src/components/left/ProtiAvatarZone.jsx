...
export default function ProtiAvatarZone() {
  ...
  const severityLabel = { 
    low: state.language === 'en' ? 'Normal' : 'সাধারণ', 
    serious: state.language === 'en' ? 'Serious' : 'গুরুতর', 
    urgent: state.language === 'en' ? 'Urgent' : 'জরুরি' 
  };
  ...
  return (
    <div className="avatar-zone">
      ...
      <div className="status-row">
        ...
        <span className="status-text">{state.language === 'en' ? 'Active' : 'সক্রিয় আছি'}</span>
      </div>
      {hasSession && (
